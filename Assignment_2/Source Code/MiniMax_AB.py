...
def MAX_VALUE(puzzleNode, isMaxPlayer, alpha, beta):
    # print('in Max_value')
    node = puzzleNode
    ...
    for childNode in maxChildren:
        ...
        returnedNode, score = getMax(childNode, isMaxPlayer, alpha, beta)
        ...
        if (alpha >= beta):
            # print('before prune:children:', len(maxChildren))
            print('pruned:')
            display(childNode.getState())
            break
...
def MIN_VALUE(puzzleNode, isMaxPlayer, alpha, beta):
    # print('in Min_value')
    node = puzzleNode
    ...
    for childNode in minChildren:
        ...
        # print('-----------------min_value for -----------------------')
        if (alpha >= beta):
            # print('before prune:children:', len(minChildren))
            print('pruned:')
            display(childNode.getState())
            break;
...
def getMax(puzzleNode, isMaxPlayer, alpha, beta):
    ...
    if (isMaxPlayer):
        # print('=============================in getMax Max')
        isMaxPlayer = True
        node, bestScore = MAX_VALUE(node, isMaxPlayer, alpha, beta)
        ...
        # print('=============================in getMax Min')
        isMaxPlayer = False
        node, bestScore = MIN_VALUE(node, isMaxPlayer, alpha, beta)
...
def miniMaxAlphaBeta(puzzleNode, isMaxPlayer, alpha, beta):  # returns
    ...
    while (True):
        ...
        if (isMaxPlayer):
            ...
            bestNode, bestScore = getMax(node, isMaxPlayer, alpha, beta)
...
alphaRoot = float('-Inf')
betaRoot = float('Inf')
miniMaxAlphaBeta(tttNode, isMax, alphaRoot, betaRoot)
